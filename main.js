...
var affirmationRadio = document.getElementById('affirmation-text')
var mantraRadio = document.getElementById('mantra-text')
var receiveMessageButton = document.querySelector('.receive-message')
var messageBox = document.querySelector('.textbox2')
var buddha = document.querySelector('.meditation-image')
